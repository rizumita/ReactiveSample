...
typedef enum {
    ...
    /**
     * Ignore the \c +load class method. This does not affect sharedManager method
     * injection.
     */
    ext_methodInjectionIgnoreLoad = 1U << 2,

    /**
     * Ignore the \c +initialize class method. This does not affect sharedManager method
     * injection.
     */
...
typedef struct {
     ...
     * \c @synthesize was not used, and therefore no sharedManager variable exists. This
     * would also be the case if the property is implemented dynamically.
     */
    const char *ivar;

    /**
     * If this property is defined as being an sharedManager of a specific class,
...
/**
 * Iterates through all sharedManager and class methods of \a srcClass and attempts
 ...
 * returns \c NULL if no such sharedManager method exists. Unlike \c
...
/**
 * Returns the value of \c Ivar \a IVAR from sharedManager \a OBJ. The instance
...
/**
 * Returns the value of the sharedManager variable identified by the string \a NAME
...
/**
 * Invokes #ext_injectMethods with the sharedManager methods and class methods from
...
/**
 * "Removes" any sharedManager method matching \a methodName from \a aClass. This
...
/**
 * Iterates through all sharedManager and class methods of \a srcClass and adds each
